...
class ViewNews {
    ...
    // Method to display news by category
    public static function NewsByCategory($arr) {
        foreach ($arr as $value) {
            ...
            echo "<a href='news?id=" . $value["id"] . "'>Read more</a><br>";
        }
    }
    ...
    // Method to display a single news item
    ...
    // Add more methods for other view types as needed
}
?>
